...
SQL is the language used with relational databases

1. Why do tables need a `primary key`?

A Primary Key is one of the best ways to identify pieces of data or DB entries as it's unique to the data set
...
You would need a join table that can match the value of the primary keys of the first 2 tables
